          ...
          <div className="container z-index-2">
            <div className="row justify-content-center">
              <div className="col-sm-9 text-center mx-auto pt-6">
                <h1 className="mb-4">Exclusive Discounts for Customers</h1>
                <p className="lead mb-sm-5 px-md-8">Get up to 20% off on your first purchase – because great beginnings deserve great savings!</p>
          ...
          <div className="row">
            <div className="col-12 col-md-6 col-lg-4">
              <div className="card border shadow-xs mb-4">
                <div className="card-body text-start p-3 w-100">
                  <Reviews rating = "4" />
                  <p className="mt-4">I ordered almonds and cashews, and the quality was amazing! Super fresh, crunchy, and packed perfectly. Will definitely be ordering again</p>
            ...
            <div className="col-12 col-md-6 col-lg-4">
              <div className="card border shadow-xs mb-4">
                <div className="card-body text-start p-3 w-100">
                  <Reviews rating = "5" />
                  <p className="mt-4">The variety of nuts available is fantastic! I love how they offer premium quality with quick delivery. A perfect go-to snack for a healthy lifestyle!</p>
                  <div className="d-flex align-items-center">
                    <div className="avatar avatar-sm position-relative me-2">
                      <img src="https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1760&q=80" className="rounded-circle" />
                    </div>
                    <h6 className="mb-0">Gurunathan</h6>
                  </div>
                </div>
              </div>
            </div>
            <div className="col-12 col-md-12 col-lg-4">
              <div className="card border shadow-xs mb-4">
                <div className="card-body text-start p-3 w-100">
                  <Reviews rating = "4" />
                  <p className="mt-4">Got an amazing discount on my first order, and the free delivery on bulk purchases is a great bonus. Highly recommended for all nut lovers!</p>
                  <div className="d-flex align-items-center">
                    <div className="avatar avatar-sm position-relative me-2">
                      <img src="https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1760&q=80" className="rounded-circle" />
                    </div>
                    <h6 className="mb-0">Roshini</h6>
                  </div>
                </div>
              </div>
            </div>
